...
public class ManageProductsActivity extends AppCompatActivity {
    ...
    private int editingProductId = -1; // ID-ul produsului care se editează
                ...
                if (conn != null) {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(ManageProductsActivity.this, "Eroare la incarcarea produselor", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
                ...
                if (conn != null) {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(ManageProductsActivity.this, "Eroare la modificarea produsului", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
                ...
                if (conn != null) {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(ManageProductsActivity.this, "Eroare la adaugarea produsului", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
                ...
                if (conn != null) {
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                // Încarcă produsele din nou după ștergere
                                loadProducts();
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(ManageProductsActivity.this, "Eroare la ștergerea produsului", Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }
